...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
        ...
        for i, step in enumerate(iterator):
            ...
            if self.model_ldm is not None:
                ...
                img_extra = None
            outs = self.p_sample_ddim(img, img_extra, cond,  ts, index=index, cond_ldm=conditioning_ldm, extra_info=extra_info, use_original_steps=ddim_use_original_steps,
    ...
    @torch.no_grad()
    #x_ldm
    def p_sample_ddim(self, x, x_extra, c, t, index, cond_ldm=None, extra_info=None, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
                      temperature=1., noise_dropout=0., score_corrector=None, corrector_kwargs=None,
                      unconditional_guidance_scale=1., unconditional_conditioning=None):
