...
if __name__ == "__main__":
    ...
    try:
        ...
        config.model.params.figure_num=len([f for f in os.listdir(opt.datapath) if os.path.isfile(os.path.join(opt.datapath, f))])
        print("figure number:", config.model.params.figure_num)
        ...
        config.model.params.task_token=opt.modifier_token.count('+') + 1
